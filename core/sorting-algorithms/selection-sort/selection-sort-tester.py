...
# Date: 2023-01-23
# Description: A unit test to test the selection sort algorithm

# This is a unit test composed of different test cases to check the correctness of the the selection_sort function in the selection_sort.py file (in the same directory)
