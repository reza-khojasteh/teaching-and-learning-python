...
# Date: 2023-01-27
# Description: A unit test to test the merge sort algorithm

# This is a unit test composed of different test cases to check the correctness of the the merge_sort function in the merge_sort.py file (in the same directory)
